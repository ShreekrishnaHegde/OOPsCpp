...
->Functions that are declared within a class are called member functions. Member
    ...
    all private elements.
->Variables that are elements of a class are called member variables  or data members. 
    (The term instance variable is also used.) Collectively, any element of
...
->No member can be an object of the class that is being declared. (Although a member can be a pointer to the class that is being
    declared.) 
